...
def health():
    ...
    return {
        "status": "ok",
        "phase": 4,  # Phase 4: AI-first pivot (ADR-028) — topic-based generation
...
def generate_from_topic(req: TopicGenerateRequest):
    ...
    return Response(
        ...
        headers={
            "Content-Disposition": f'attachment; filename="presentation.{req.export_format}"',
