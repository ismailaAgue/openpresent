...
def _recipe_from_dict(d: dict) -> Recipe:
    ...
    slides = [
        Slide(
            ...
            # ADR-038 fix — see sqlite_storage.py's identical fix for
            # the full explanation. Same bug, duplicated in both
            # storage adapters: layout_type/image_query silently
